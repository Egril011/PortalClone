...
APortalCloneCharacter::APortalCloneCharacter()
{
...
void APortalCloneCharacter::NotifyControllerChanged()
{
...
void APortalCloneCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APortalCloneCharacter::Move);
...
void APortalCloneCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APortalCloneCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
